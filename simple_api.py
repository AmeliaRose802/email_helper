    ...
    try:
        if not services_available:
            ...
            try:
                ...
                # Use days_back=30 to get recent unread emails from past month
                recent_emails = outlook_manager.get_recent_emails(days_back=30, max_emails=limit)
...
async def process_emails(request: dict = None):
    ...
    try:
        ...
        # Use None for days_back to process all unread emails regardless of age
