    ...
    def classify_email_with_explanation(
        ...
        **_ignored,
        ...
        Args:
            ...
            **_ignored: Additional legacy keyword arguments retained for compat
...
Learning History: {learning_data_len} previous decisions"""
    ...
    def _get_few_shot_examples(
        ...
        successful = learning_data[
            not learning_data.get('user_modified', False)
    ...
    def _generate_explanation(self, email_content: dict, category: str) -> str:
        ...
        explanations = {
            ...
            'team_action': "Email indicates action required from your team.",
            'optional_action': "Email contains optional activities that may be worth considering.",
            'work_relevant': "Email contains work-related information but requires no immediate action.",
            'fyi': "Email is informational only with no action required.",
            'newsletter': "Email appears to be a newsletter or bulk distribution.",
            'spam_to_delete': "Email does not appear relevant to work.",
            'job_listing': "Email contains job opportunities or recruitment content.",
            'optional_event': "Email contains optional event invitation."
        }
