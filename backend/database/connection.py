...
class DatabaseManager:
    ...
    def close_all_connections(self):
        ...
        Note: Since we use context managers, connections are automatically closed
        after use. This method is provided for explicit cleanup during shutdown.
        """
        # SQLite connections are closed by context managers, so this is mainly
        # for explicit cleanup signaling during shutdown
        pass
