...
class OutlookEmailAdapter(EmailProvider):
    ...
    def move_email(self, email_id: str, destination_folder: str) -> bool:
        ...
        try:
            ...
            print("Checking OutlookManager.folders dictionary...")
            ...
            if not target_folder:
                print("Folder not found in dictionary, searching Outlook folder structure...")
                ...
                print("Searching inbox subfolders...")
                ...
                if not target_folder:
                    print("Searching mail root folders...")
            ...
            import traceback
            traceback.print_exc()
            print("=== Move operation failed with exception ===\n")
            return False
