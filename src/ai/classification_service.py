"""Email Classification Service - AI-powered email categorization.

This module provides email classification functionality with confidence-based
auto-approval, few-shot learning from historical data, and comprehensive
...
from utils import clean_ai_response, parse_json_with_fallback
...
class EmailClassificationService:
    ...
    This service provides sophisticated email classification using AI with:
    ...
    def __init__(self, prompt_executor, context_manager):
        ...
        Args:
            ...
            context_manager: UserContextManager for user-specific context
        """
